<template>
    ...
    <div class="dialogue-title-wrapper">
        ...
        <div class="title">
            <h3 class="top-sub">Adjacency Matrice</h3>
            <h3>Agreement and Actors in a matrice</h3>
    ...
    <div class="adjacencymatrics2">
        <div id="adjacencymatrics2" style="position: relative; "></div>
    </div>
    </div>
</template>
...
export default ({
    ...
    methods: {
        getSize() {
            let matricsDiv = document.querySelector('.adjacencymatrics2')
